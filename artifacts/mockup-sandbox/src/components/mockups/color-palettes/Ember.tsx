export function Ember() {
  const bg = "#0c0700";
  const surface = "#1a1000";
  const surface2 = "#261800";
  const border = "#3d2800";
  const accent = "#f59e0b";
  ...
  const cats = [
    { name: "Sleep", color: "#92400e", hours: 52 },
    { name: "Work", color: "#b45309", hours: 40 },
    { name: "Learning", color: "#d97706", hours: 14 },
    { name: "Family", color: "#ea580c", hours: 18 },
    { name: "Fitness", color: "#f59e0b", hours: 8 },
    { name: "Wasted", color: "#292524", hours: 6 },
  ];

  const grid = [
    ["#92400e","#92400e","#b45309","#b45309","#b45309","#b45309","#b45309"],
    ["#92400e","#d97706","#b45309","#b45309","#d97706","#b45309","#ea580c"],
    ["#f59e0b","#d97706","#d97706","#b45309","#d97706","#f59e0b","#ea580c"],
    ["#92400e","#92400e","#292524","#ea580c","#292524","#92400e","#92400e"],
    ["#92400e","#92400e","#b45309","#b45309","#b45309","#92400e","#92400e"],
  ];

  return (
    <div style={{ minHeight: "100vh", background: "#080400", display: "flex", alignItems: "center", justifyContent: "center", padding: 24, fontFamily: "Inter, sans-serif" }}>
      <div style={{ width: 380, borderRadius: 20, overflow: "hidden", border: `1px solid ${border}`, boxShadow: `0 0 60px ${accent}25, 0 24px 48px rgba(0,0,0,0.7)` }}>
        ...
        <div style={{ background: surface, borderTop: `1px solid ${border}`, padding: "12px 14px", display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
          {[{ l: "Productive", v: "54h", color: accent2 }, { l: "Sleep", v: "52h", color: "#fcd34d" }, { l: "Wasted", v: "6h", color: "#f87171" }].map(s => (
        ...
        <div style={{ background: surface2, padding: "10px 16px", borderTop: `1px solid ${border}`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <div style={{ fontSize: 12, fontWeight: 800, color: text }}>Ember Amber</div>
            <div style={{ fontSize: 10, color: muted, marginTop: 1 }}>Warm & energetic · Golden fire</div>
          </div>
          <div style={{ display: "flex", gap: 4 }}>
            {[bg, surface, accent, "#ea580c", "#92400e"].map((c, i) => (
